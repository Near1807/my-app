...
export function GetAnswers(quiz: number) {
  const answers = [
    ...
    {
      15: "You are a **Fire-type Pokémon**! Passionate, bold, energetic, and driven. You face challenges head-on and light up every room you enter.",
      30: "You are a **Water-type Pokémon**! Calm, adaptable, thoughtful, and intuitive. You flow around obstacles and bring peace to those around you.",
      45: "You are a **Grass-type Pokémon**! Grounded, patient, steady, and nurturing. You grow at your own pace and help others thrive along the way.",
      60: "You are an **Electric-type Pokémon**! Quick-thinking, dynamic, curious, and full of spark. Your ideas strike fast and inspire everyone around you.",
    },
  ];
  return answers[quiz];
}
