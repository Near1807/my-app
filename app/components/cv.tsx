export function Card(props: {className?: string; children:React.ReactNode}) {
    return(
        <div className={`bg-white rounded-xl border border-gray-300 p-4 ${props.className}`}>
            {props.children}
        </div>)
}
...
export function Title(props: {className?: string; children:React.ReactNode}) {
    return(
        <h1 className={`text-xl font-bold mb-4 ${props.className}`}>
            {props.children}
        </h1>
    )
}
export function Subtext(props: {className:string; children:React.ReactNode}) {
    return(
        <h1 className={`text-xs ${props.className}`}>{props.children}</h1>
    )
}
export function Subtitle(props: {className:string; children:React.ReactNode}) {
    return(
        <h2 className={`text-lg font-semibold ${props.className}`}>{props.children}</h2>
    )
}
export function Text(props: {className?: string; children:React.ReactNode}) {
    return(
        <p className={`text-sm ${props.className}`}>
            {props.children}
        </p>
    )
}
...
export function Divider(){
    return(
        <>
        <br />
            <div className="bg-gray-400 grow h-0.25"></div>
        <br />
        </>
    )
}
